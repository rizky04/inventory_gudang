          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name_variant" id="name_variant" placeholder="Name Variant" value="{{ old('name_variant', $name_variant ?? '') }}">
                    <small class="text-danger"></small>
                </div>
                <div class="form-group">
                    <label for="price_variant" class="form-label">Price</label>
                    <input type="number" class="form-control" name="price_variant" id="price_variant" placeholder="Price" value="{{ old('price_variant', $price_variant ?? '') }}">
                    <small class="text-danger"></small>
                </div>
                <div class="form-group">
                    <label for="stok_variant" class="form-label">Stock Variant</label>
                    <input type="number" class="form-control" name="stok_variant" id="stok_variant" placeholder="Stok Variant" value="{{ old('stok_variant', $stok_variant ?? '') }}">
                    <small class="text-danger"></small>
                </div>
                <div class="form-group">
